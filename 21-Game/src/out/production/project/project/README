...
2.Set up players by entering number of human players (1-4)
    -Enter the numnber of AI players (up to a maximum of 4 total players)
3.Each player recieves 2 cards (Dealer has 1 card and 1 hidden card)
...
- Lastly dealer will reveal hidden card and draw until reacing at minimum 16
4. If a player/bot has higher than the dealer then they win!
If a player tied with the dealer then its a push, otherwise they lose.
